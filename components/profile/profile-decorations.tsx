    ...
    >
      ...
      {themeId === "glass-dark" && (
        <>
          ...
          <svg
            viewBox="0 0 100 100"
            className="absolute bottom-24 right-[8%] w-56 h-56 opacity-[0.03] stroke-current text-[#e6e6fa] fill-none stroke-[0.5]"
          >
          ...
          <svg
            viewBox="0 0 100 100"
            className="absolute top-16 left-[10%] w-10 h-10 opacity-[0.04] stroke-current text-[#e6e6fa] fill-none stroke-[0.75]"
          >
      ...
      {themeId === "japan-minimal" && (
        <>
          ...
          <svg
            viewBox="0 0 24 24"
            className="absolute top-1/4 right-[30%] w-5 h-5 opacity-[0.08] fill-[#d4a5a5] rotate-12"
          >
          ...
          <svg
            viewBox="0 0 24 24"
            className="absolute top-1/3 left-[15%] w-6 h-6 opacity-[0.06] fill-[#d4a5a5] -rotate-45"
          >
            <path d="M12,21C12,21 16,16.5 17.5,13.5C19,10.5 19,7 16,7C14,7 12.5,8.5 12,10C11.5,8.5 10,7 8,7C5,7 5,10.5 6.5,13.5C8,16.5 12,21 12,21Z" />
          </svg>
          <svg
            viewBox="0 0 24 24"
            className="absolute bottom-[30%] right-[20%] w-4.5 h-4.5 opacity-[0.07] fill-[#d4a5a5] rotate-[60deg]"
          >
            <path d="M12,21C12,21 16,16.5 17.5,13.5C19,10.5 19,7 16,7C14,7 12.5,8.5 12,10C11.5,8.5 10,7 8,7C5,7 5,10.5 6.5,13.5C8,16.5 12,21 12,21Z" />
          </svg>
        </>
      ...
      {themeId === "lofi-coffee" && (
        <>
          ...
          <svg
            viewBox="0 0 24 24"
            className="absolute bottom-28 left-[8%] w-10 h-10 opacity-[0.04] fill-[#faf9f6] rotate-45"
          >
          ...
          <svg
            viewBox="0 0 24 24"
            className="absolute top-[40%] right-[10%] w-7 h-7 opacity-[0.03] fill-[#faf9f6] -rotate-12"
          >
            <path d="M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2M12,4C14.75,4 17.15,5.6 18.25,8C17,9 15.5,9.5 13.5,9C11.5,8.5 10.5,7 9.5,5.5C8.85,4.5 7.85,4 6.75,4C8.25,4.75 9.5,6.5 11,7C12.5,7.5 13.5,6.5 14.5,5C15.25,4.35 16.25,4 17.25,4M6.75,4C5.25,5.25 4.5,7.25 4.5,9.5C4.5,12 5.5,14 7,15.5C8.5,17 11.5,18.5 13,19.5C14.5,20.5 16.5,20 18.25,18C16.5,19.25 14.5,18.75 13,17.5C11.5,16.25 10,14.5 8.5,13C7,11.5 6,9.5 6.75,4Z" />
          </svg>
        </>
      ...
      {themeId === "ocean-depths" && (
        <>
          ...
          <svg
            ...
            className="absolute bottom-0 left-0 w-full h-20 opacity-[0.03] text-[#00e5ff] fill-current"
          >
          ...
          <svg
            viewBox="0 0 100 20"
            preserveAspectRatio="none"
            className="absolute bottom-0 left-0 w-full h-14 opacity-[0.02] text-[#0077b6] fill-current"
          >
      ...
      {themeId === "sunset-boulevard" && (
        <>
          ...
          <svg
            viewBox="0 0 100 100"
            className="absolute -bottom-16 right-[5%] w-80 h-80 opacity-[0.04] text-[#ff7e5f] fill-current"
          >
            ...
            <line
              ...
              x2="100"
              y2="58"
              className="stroke-[#140b18] stroke-[3]"
            />
            <line
              x1="0"
              y1="68"
              x2="100"
              y2="68"
              className="stroke-[#140b18] stroke-[4]"
            />
            <line
              x1="0"
              y1="78"
              x2="100"
              y2="78"
              className="stroke-[#140b18] stroke-[6]"
            />
          </svg>
          {/* Faint orbit rays at top left */}
          <svg
            viewBox="0 0 100 100"
            className="absolute top-16 left-[5%] w-48 h-48 opacity-[0.02] stroke-[#ff007f] stroke-[0.5] fill-none"
          >
      ...
      {themeId === "forest-canopy" && (
        <>
          ...
          <svg
            viewBox="0 0 24 24"
            className="absolute top-16 right-[8%] w-32 h-32 opacity-[0.03] fill-[#52b788] rotate-[30deg]"
          >
          ...
          <svg
            viewBox="0 0 24 24"
            className="absolute bottom-24 left-[5%] w-40 h-40 opacity-[0.02] fill-[#52b788] -rotate-[45deg]"
          >
            <path d="M17,8C15,6 12,6 10,8C8,10 8,13 10,15C11.5,16.5 13.5,17 15,16.5C16.5,16 17,14.5 16.5,13C16,11.5 14,10 12,12C10.5,13.5 10.5,15.5 12,17C10,17 7.5,15 6,12C4.5,9 5,6.5 7,4.5C9,2.5 11.5,2 14.5,3C17.5,4 18.5,6.5 17,8Z" />
          </svg>
        </>
      ...
      {themeId === "golden-hour" && (
        <>
          ...
          <svg
            viewBox="0 0 100 100"
            className="absolute -top-16 -left-16 w-[450px] h-[450px] opacity-[0.03] text-[#f4a900] fill-none stroke-current stroke-[0.2]"
          >
      ...
      {themeId === "arctic-frost" && (
        <>
          ...
          <svg
            viewBox="0 0 24 24"
            className="absolute top-24 right-[10%] w-14 h-14 opacity-[0.04] text-[#90e0ef] fill-none stroke-current stroke-[0.5]"
          >
          ...
          <svg
            viewBox="0 0 24 24"
            className="absolute bottom-32 left-[8%] w-20 h-20 opacity-[0.03] text-[#3a86c8] fill-none stroke-current stroke-[0.5]"
          >
            <line x1="12" y1="2" x2="12" y2="22" />
            <line x1="2" y1="12" x2="22" y2="12" />
            <line x1="5" y1="5" x2="19" y2="19" />
      ...
      {themeId === "desert-rose" && (
        <>
          ...
          <svg
            viewBox="0 0 100 100"
            preserveAspectRatio="none"
            className="absolute bottom-0 left-0 w-full h-36 opacity-[0.03] text-[#cd7f64] fill-none stroke-current stroke-[0.5]"
          >
          ...
          <svg
            viewBox="0 0 24 24"
            className="absolute top-24 right-[12%] w-16 h-16 opacity-[0.04] fill-[#cd7f64]"
          >
      ...
      {themeId === "tech-innovation" && (
        <>
          ...
          <div className="absolute top-1/3 right-[8%] font-mono text-xs text-[#06b6d4]/10 select-none">
            +
          </div>
          <div className="absolute bottom-1/3 left-[8%] font-mono text-xs text-[#6366f1]/10 select-none">
            +
          </div>
        </>
      )}
      ...
      {themeId === "botanical-garden" && (
        <>
          ...
          <svg
            viewBox="0 0 24 24"
            className="absolute top-16 right-[6%] w-28 h-28 opacity-[0.04] fill-[#74c69d] rotate-[45deg]"
          >
            <path d="M17,8C15,6 12,6 10,8C8,10 8,13 10,15C11.5,16.5 13.5,17 15,16.5C16.5,16 17,14.5 16.5,13C16,11.5 14,10 12,12C10.5,13.5 10.5,15.5 12,17C10,17 7.5,15 6,12C4.5,9 5,6.5 7,4.5C9,2.5 11.5,2 14.5,3C17.5,4 18.5,6.5 17,8Z" />
          </svg>
          <svg
            viewBox="0 0 24 24"
            className="absolute bottom-20 left-[4%] w-36 h-36 opacity-[0.03] fill-[#74c69d] -rotate-[60deg]"
          >
          ...
          <svg
            viewBox="0 0 24 24"
            className="absolute top-[35%] left-[15%] w-6 h-6 opacity-[0.06] fill-[#74c69d] rotate-[15deg]"
          >
            <path d="M17,8C15,6 12,6 10,8C8,10 8,13 10,15C11.5,16.5 13.5,17 15,16.5" />
          </svg>
          <svg
            viewBox="0 0 24 24"
            className="absolute bottom-[35%] right-[15%] w-8 h-8 opacity-[0.04] fill-[#74c69d] -rotate-[30deg]"
          >
            <path d="M17,8C15,6 12,6 10,8C8,10 8,13 10,15C11.5,16.5 13.5,17 15,16.5" />
          </svg>
        </>
      ...
      {themeId === "midnight-galaxy" && (
        <>
          ...
          <svg
            viewBox="0 0 100 100"
            className="absolute top-[20%] right-[-8%] w-[380px] h-[380px] opacity-[0.04] text-[#d946ef] fill-none stroke-current stroke-[0.25] stroke-dashed -rotate-12"
          >
            <circle cx="50" cy="50" r="45" />
          ...
          <svg
            viewBox="0 0 24 24"
            className="absolute top-24 left-[18%] w-5 h-5 opacity-[0.08] fill-[#6366f1] animate-[pulse_3s_infinite_1s]"
          >
            <path d="M12,2L14.5,9.5L22,12L14.5,14.5L12,22L9.5,14.5L2,12L9.5,9.5Z" />
          </svg>
          <svg
            viewBox="0 0 24 24"
            className="absolute bottom-32 right-[12%] w-6 h-6 opacity-[0.08] fill-[#d946ef] animate-[pulse_4s_infinite_2s]"
          >
            <path d="M12,2L14.5,9.5L22,12L14.5,14.5L12,22L9.5,14.5L2,12L9.5,9.5Z" />
          </svg>
        </>
