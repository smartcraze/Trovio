...
export const THEMES: Record<string, IThemeConfig> = {
  ...
  "glass-dark": {
    ...
    patternClass:
      "bg-[radial-gradient(circle_at_15%_20%,rgba(255,255,255,0.08),transparent_55%),radial-gradient(circle_at_80%_0%,rgba(124,58,237,0.12),transparent_45%)] opacity-60",
    cardClass:
    ...
    sectionHeaderClass:
      "text-zinc-500 uppercase tracking-widest text-xs font-medium",
    accentClass:
  ...
  "japan-minimal": {
    ...
    emoji: "🌸",
    bgClass: "bg-[#0C0A0D] text-white min-h-screen relative overflow-hidden",
    fontClass: "font-serif",
    glowClass:
      "absolute top-[5%] right-[-5%] w-[50%] h-[60%] bg-rose-400/[0.07] rounded-full blur-[160px] pointer-events-none",
    patternClass:
      "bg-[linear-gradient(120deg,rgba(255,255,255,0.05),transparent_40%),linear-gradient(300deg,rgba(244,114,182,0.08),transparent_45%)] opacity-70",
    cardClass:
  ...
  "anime-sakura": {
    ...
    emoji: "🎌",
    bgClass: "bg-[#0D0A2E] text-white min-h-screen relative overflow-hidden",
    fontClass: "font-sans",
    glowClass:
      "absolute top-[0%] left-[-5%] w-[70%] h-[50%] bg-pink-500/[0.12] rounded-full blur-[120px] pointer-events-none",
    patternClass:
      "bg-[radial-gradient(circle_at_20%_0%,rgba(236,72,153,0.18),transparent_50%),radial-gradient(circle_at_90%_30%,rgba(139,92,246,0.18),transparent_45%)] opacity-70",
    cardClass:
    ...
    avatarRing: "ring-2 ring-pink-400/60 ring-offset-4 ring-offset-[#0D0A2E]",
  },
  ...
  cyberpunk: {
    ...
    patternClass:
      "bg-[linear-gradient(90deg,rgba(255,255,255,0.05)_1px,transparent_1px),linear-gradient(0deg,rgba(255,255,255,0.04)_1px,transparent_1px)] bg-[length:28px_28px] opacity-50",
    cardClass:
  ...
  "golden-hour": {
    ...
    fontClass: "font-sans",
    glowClass:
      "absolute top-[10%] left-[5%] w-[55%] h-[55%] bg-[#f4a900]/[0.10] rounded-full blur-[150px] pointer-events-none",
    patternClass:
      "bg-[radial-gradient(circle_at_20%_20%,rgba(244,169,0,0.12),transparent_55%),radial-gradient(circle_at_80%_60%,rgba(193,102,107,0.18),transparent_55%)] opacity-70",
    cardClass:
      "bg-[#d4b896]/[0.08] border border-[#d4b896]/[0.18] backdrop-blur-2xl shadow-2xl shadow-[#4a403a]/30",
  ...
  "lofi-coffee": {
    ...
    name: "LoFi Coffee",
    emoji: "☕",
    bgClass: "bg-[#110D08] text-amber-50 min-h-screen relative overflow-hidden",
    fontClass: "font-sans",
    glowClass:
      "absolute top-[20%] right-[0%] w-[50%] h-[50%] bg-amber-600/[0.08] rounded-full blur-[150px] pointer-events-none",
    patternClass:
      "bg-[radial-gradient(circle_at_20%_80%,rgba(251,191,36,0.12),transparent_55%),radial-gradient(circle_at_80%_20%,rgba(120,53,15,0.2),transparent_55%)] opacity-60",
    cardClass:
  ...
  "neon-ocean": {
    ...
    name: "Neon Ocean",
    emoji: "🌊",
    bgClass: "bg-[#020B18] text-cyan-50 min-h-screen relative overflow-hidden",
    fontClass: "font-sans",
    glowClass:
      "absolute bottom-[-5%] left-[20%] w-[60%] h-[60%] bg-cyan-500/[0.08] rounded-full blur-[150px] pointer-events-none",
    patternClass:
      "bg-[radial-gradient(circle_at_20%_70%,rgba(34,211,238,0.12),transparent_55%),radial-gradient(circle_at_80%_30%,rgba(14,116,144,0.2),transparent_50%)] opacity-70",
    cardClass:
