  ...
  return (
    <div className="bg-background text-foreground min-h-screen relative overflow-hidden font-sans">
      ...
      <section className="max-w-6xl mx-auto px-4 py-20 relative z-10">
        <div className="relative rounded-[36px] bg-gradient-to-br from-primary/10 via-secondary/15 to-transparent border border-border p-8 sm:p-16 text-center overflow-hidden">
          {/* Glow Effect */}
          ...
          <Link href="/register">
            <button className="h-12 px-8 rounded-full bg-primary text-primary-foreground font-bold flex items-center justify-center gap-2 mx-auto hover:bg-primary/90 transition shadow-xl">
